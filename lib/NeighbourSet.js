...
function NeighbourSet(loggingService) {
    ...
    /**
     * Reset the age of the specified neighbour to zero
     *
     * @param id
     */
    this.resetAge = function (id) {
        neighbours[id].age = 0;
    };
    ...
    this.mergeNodePointerIfNewer = function (node) {
        ...
        if (myNode) {
            ...
            loggingService.warn("Attempt was made to merge node not in set");
        }
    };
}
